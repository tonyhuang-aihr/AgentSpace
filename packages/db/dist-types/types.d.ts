...
export type WorkspaceNotificationResourceType = "workspace" | "workspace_member" | "agent" | "agent_fork_invitation" | "channel" | "document" | "runtime" | "task" | "approval";
...
export declare const TASK_EXECUTION_EVENT_TYPES: readonly ["queued", "assigned", "workspace_prepared", "context_loaded", "tool_started", "tool_finished", "artifact_detected", "artifact_collected", "approval_requested", "approval_reviewed", "blocked", "handoff_created", "message_posted", "completed", "failed", "cancelled"];
...
export declare function isNativeTaskStatus(value: unknown): value is NativeTaskStatus;
export declare function isTaskExecutionEventType(value: unknown): value is TaskExecutionEventType;
export declare function isTaskExecutionEventSeverity(value: unknown): value is TaskExecutionEventSeverity;
export declare function isTaskExecutionEventStatus(value: unknown): value is TaskExecutionEventStatus;
...
export declare function priorityToNumber(priority: EnqueueTaskInput["priority"]): number;
